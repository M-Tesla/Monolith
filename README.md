...
A storage engine. Not a database. Not a query language. Not a server.
...
Every commit writes dirty pages, then atomically flips the meta slot. Crash at any point leaves the previous meta intact. No WAL file. No journal. No recovery process.
